function [code_array, n_payload_corrected] = frame_decoder(sig, sf, coefficient_matrix, final_data_frequency_packet)
...
for lp = 0:n_packet - 1
    ...
    [rz,pk_phase] = chirp_comp_alias(rz_o, fs/bw);
